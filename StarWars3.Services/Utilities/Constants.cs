namespace StarWars3.Services.Utilities
{
    public static class Constants
    {
        ...
        public const int MineralsFactoryHealth = 100;
        public const int WarFactoryHealth = 100;
        public const int EngineeringFactoryHealth = 100;
        public const int DefaultFactoryLevel = 0;

        // Factory upgrades
        public const int ArmorLevel = 0;
        //
